...
DEFAULT_PACKAGES.router:=\
	...
	iptables-mod-tproxy iptables-mod-extra ipset ip-full default-settings luci luci-newapi uuidgen bash\
	ddns-scripts_aliyun ddns-scripts_dnspod luci-app-ddns luci-app-upnp luci-app-autoreboot \
	luci-app-arpbind  luci-app-accesscontrol luci-app-nlbwmon luci-app-turboacc luci-app-wol curl ca-certificates \
	ipv6helper ip6tables-extra ip6tables-mod-nat openssh-sftp-client openssh-sftp-server
